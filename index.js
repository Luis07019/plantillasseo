...
(window,"q2o"),function(e,t) {
    ...
    function T(e,t) {
        ...
        u(i,J+"-loading"),y(g(A)+h(s(D.query, {
            callback:"_"+B,"max-results":Q,q:e,"start-index":t
        })),
        function() {
    ...
    B=Date.now(),R= {
        i:B,direction:"ltr",url:E.protocol+"//"+E.host,name:"js-search",css:1,ad:!0,live:!0,source:'form[action$="/search"]',container:0,excerpt:0,image:0,target:0,chunk:50,text: {previous:"Previous",next:"Next",empty:"No results for query <em>%s%</em>.",end:"No more results for query <em>%s%</em>."
        },
        query: {
                ...
                if(e) {
                    ...
                    if(str="",t) {
                        if(b) {
                            ...
                            b===!0&&(b=80),a(b)?(r=n=b+"px",b="s"+b+"-c"):(i=/^s(\d+)(\-[cp])?$/.exec(b))?(r=i[1]+"px",n=i[2]?i[1]+"px":"auto"):(i=/^w(\d+)\-h(\d+)(\-[cp])?$/.exec(b))&&(r=i[1]+"px",n=i[2]+"px"),str+='<p class="'+J+"-image "+(o?"loading":"no-image")+'">',str+=o?'<img alt="" src="'+e.media$thumbnail.url.replace(/\/s\d+(\-c)?\//g,"/"+b+"/")+'" style="display:block;
                            width:'+r+";
                            height:"+n+';
