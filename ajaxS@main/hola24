...
!function(e,t) {
    function r(e,t) {
        ...
        function a(e) {
            return i(e)&&""!==e.trim()?'""'===e||"[]"===e||" {
            }
            "===e||'"'===e[0]&&'"'===e.slice(-1)||"["===e[0]&&"]"===e.slice(-1)||" {
                "===e[0]&&"
            }
            "===e.slice(-1):!1
        }
        ...
        function s(e,t,r) {
            for(var n,i=t.split("["),a=0,o=i.length;
            o-1>a;
            ++a)n=i[a].replace(/\]$/,""),e=e[n]||(e[n]= {
            });
            e[i[a].replace(/\]$/,"")]=r
        }
        var l= {
        ...
        c=e.replace(/^.*?\?/,"");
        return""===c?l:(c.split(/&(?:amp;
        )?/).forEach(function(e) {
            var i=e.split("="),a=r(i[0]),c=n(i[1])?r(i[1]):!0;
...
(window,"q2o"),function(e,t) {
    ...
    function c(e,r,i) {
        if(e=t.createElement(e),n(r)&&""!==r&&(e.innerHTML=r),o(i))for(var a in i)i[a]!==!1&&e.setAttribute(a,i[a]);
        return e
    }
    function u(e,t) {
        t=t.split(/\s+/);
    ...
    function y(e,t,r) {
        var n=/\.css$/i.test(m(e)),i=c(n?"link":"script","",s(n? {
    ...
    function b(t) {
        if(!D.container&&X.parentNode) {
            var r=P.getBoundingClientRect(),n=r.top,i=r.left,a=r.width,o=r.height;
            u(X,J+"-float"),X.style.cssText="background-color:"+$("background-color")+";
            color:"+$("color")+";
            position:fixed;
            z-index:9999;
            top:"+(n+o)+"px;
            left:"+i+"px;
            width:"+a+"px;
            max-height:"+(e.innerHeight-n-o)+"px;
            overflow:auto;
            ",v(X,t&&t.type||"fit",[r])
        }
    }
    function q(e,t) {
        var r=_[e][t],n=X.children[0],i=1===I?"empty":"end";
    ...
    function T(e,t) {
        ...
        u(a,J+"-loading"),y(g(A)+h(s(D.query, {
            callback:"_"+B,"max-results":Q,q:r(e),"start-index":t
        })),
        function() {
    ...
    var L=e.q2o,M=t.currentScript,E=e.location,H=e.localStorage,j="",I=1,_= {
    },
    B=Date.now(),R= {
        i:B,direction:"ltr",url:E.protocol+"//"+E.host,name:"ajax-search",css:1,ad:!0,live:!0,source:'form[action$="/search"]',container:0,excerpt:0,image:0,target:0,chunk:50,text: {
            title:"Search results for query <em>%s%</em>",loading:"Searching&hellip;
            ",previous:"Previous",next:"Next",empty:"No results for query <em>%s%</em>.",end:"No more results for query <em>%s%</em>."
        },
        query: {
            alt:"json",orderby:"updated"
        }
    },
    z=t.head,D=s(R,L(M.src)),P=t.querySelector(D.source);
    if(P) {
        var U=D.i,A=D.id||m(D.url),J=D.name,O=D.ad,V=D.e;
        V=V&&e[V],O===!0&&(O=3);
        var F=L(E.search);
        n(F[U])&&(delete F[U].url,D=s(D,F[U]));
        var G,K=D.text,Q=D.chunk,W=D.container&&t.querySelector(D.container)||t.body,X=c("div","<div></div>", {
            "class":J+" "+D.direction,id:J+":"+U
        }),
        Y=c("div"),Z=c("h3","", {
            "class":J+"-title"
        }),
        et=c("ol","", {
            "class":J+"-results",id:J+"-results:"+U,start:I
        }),
        tt=c("nav","", {
            "class":J+"-pager",id:J+"-pager:"+U
        }),
        rt=c("a",K.previous, {
            "class":J+"-previous",href:"",rel:"prev"
        }),
        nt=c("a",K.next, {
            "class":J+"-next",href:"",rel:"next"
        }),
        it=c("p",K.loading, {
            "class":J+"-loading"
        });
        l(e,"scroll",b),l(e,"resize",b),e["_"+B]=function(e) {
            ...
            var n,i,o,m=e.entry||[],k=m.length,$=D.target,b=D.image,q=D.excerpt,T="has-title has-url";
                ...
                if(e) {
                    ...
                    if(str="",t) {
                        if(b) {
                            ...
                            b===!0&&(b=60),a(b)?(r=n=b+"px",b="s"+b+"-c"):(i=/^s(\d+)(\-[cp])?$/.exec(b))?(r=i[1]+"px",n=i[2]?i[1]+"px":"auto"):(i=/^w(\d+)\-h(\d+)(\-[cp])?$/.exec(b))&&(r=i[1]+"px",n=i[2]+"px"),str+='<p class="'+J+"-image "+(o?"loading":"no-image")+'">',str+=o?'<img class="lazyload" alt="" src="'+e.media$thumbnail.url.replace(/\/s\d+(\-c)?\//g,"/"+b+"/")+'" style="display:block;
                            width:'+r+";
                            height:"+n+';
                            ">':'<span class="img lazyload" style="display:block;
                            width:'+r+";
                            height:"+n+';
                            ">',str+="</p>"
                        }
                        if(str+='<h4 class="'+J+'-title"><a href="'+t+'"'+($?' target="'+$+'"':"")+">"+w(e.title.$t)+"</a></h4>",q) {
                            var s=e.summary.$t.replace(/<.*?>/g,"").replace(/[<>]/g,"").trim(),l=s.length;
                            q===!0&&(q=200),str+='<p class="'+J+"-excerpt"+(l?"":" no-excerpt")+'">'+w(s.slice(0,q))+(l>q?"&hellip;
                            ":"")+"</p>"
                        }
                        return c("li",str)
                    }
            ...
            if(d(o,Z),d(o,et),d(o,tt),b) {
                var N=et.getElementsByTagName("img"),S=function() {
                ...
                for(n=0,i=N.length;
                i>n;
                ++n)l(N[n],"error",S),l(N[n],"load",C)
            }
            x()&&y(g("1213961805302959224")+h(s(D.query, {
                callback:"_"+B+"_","max-results":21,orderby:"updated"
            }))
